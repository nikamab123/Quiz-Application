...
<body >
    <div class="container">
        ...
        <h2 class="text-center text-info">This is C Basics Module</h2></br>
         <div class="col-lg-8 m-auto d-block">   
        <div class=" text-center card-header">
            <h5>Welcome <?php echo $_SESSION['username'];?>, You have to select only one option from 4. Best of luck!</h4>
        </div>
