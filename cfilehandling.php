...
<body >
    <div class="container">
        ...
        <h2 class="text-center text-info">This is C File Handling Module</h2></br>
    ...
    <form action="cfilehandlingcheck.php" method="post">
    ...
    for($i=1;$i<11;$i++){
    $q="select * from cfilehandling where qid=$i";
    ...
    ?>
        ...
        <div class="card">
            ...
            <?php
                $q="select * from cfilehandlinganswers where ans_id=$i";
