...
<body >
    <div class="container">
        ...
        <h2 class="text-center text-info">This is C Function & Pointers Module</h2></br>
 
        <div class="col-lg-8 m-auto d-block">   
        <div class=" text-center card-header">
            <h5>Welcome <?php echo $_SESSION['username'];?>, You have to select only one from 4. Best of luck!</h4>
        </div>
    <form action="cfuncheck.php" method="post">
    ...
    for($i=1;$i<11;$i++){
    $q="select * from cfquestions where qid=$i";
    ...
    ?>
        ...
        <div class="card">
            ...
            <?php
                $q="select * from cfanswers where ans_id=$i";
