    ...
    //    echo "Success";
       ...
       if(isset($_POST['submit']))
       {
           if(!empty($_POST['quizcheck']))
           {
               ...
               echo"<br><br><div class='score'><center><h2>" . $_SESSION['username'] ." , Your Result in C Basics </center></h2></div><br><br>";
               ...
               $q="select * from questions limit 10";
...
<a href="cfquestions.php"><button type="button" class="btn btn-success">Next Module</button></a>
</div>
</body>
</html>