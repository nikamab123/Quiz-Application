...
--
-- Table structure for table `cppbasic`
--

CREATE TABLE `cppbasic` (
  `qid` int(250) NOT NULL,
  `question` varchar(250) DEFAULT NULL,
  `ans_id` int(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `cppbasic`
--

INSERT INTO `cppbasic` (`qid`, `question`, `ans_id`) VALUES
(1, 'Which of the following is the correct syntax to add the header file in the C++ program?', 4),
(2, 'Which of the following is the correct identifier?', 7),
(3, 'Which of the following is the address operator?', 11),
(4, 'Which of the following features must be supported by any programming language to become a pure object-oriented programming language?', 16),
(5, 'The programming language that has the ability to create new data types is called___.', 20);

-- --------------------------------------------------------

--
-- Table structure for table `cppbasicanswers`
--

CREATE TABLE `cppbasicanswers` (
  `aid` int(250) NOT NULL,
  `answer` varchar(250) DEFAULT NULL,
  `ans_id` int(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `cppbasicanswers`
--

INSERT INTO `cppbasicanswers` (`aid`, `answer`, `ans_id`) VALUES
(1, '#include\\<\'userdefined.h\\>', 1),
(2, '#include>userdefined.h', 1),
(3, '<include> userdefined.h', 1),
(4, 'Both A and B', 1),
(5, '$var_name', 2),
(6, 'varname@', 2),
(7, 'VAR_123', 2),
...
--
-- Table structure for table `cppgraph`
--

CREATE TABLE `cppgraph` (
  `user` varchar(255) DEFAULT NULL,
  `basic` int(10) DEFAULT NULL,
  `oops` int(10) DEFAULT NULL,
  `constructor` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cppgraph`
--

INSERT INTO `cppgraph` (`user`, `basic`, `oops`, `constructor`) VALUES
('vaibhav', 20, NULL, NULL);
...
--
-- Indexes for table `cppbasic`
--
ALTER TABLE `cppbasic`
  ADD PRIMARY KEY (`qid`);

--
-- Indexes for table `cppbasicanswers`
--
ALTER TABLE `cppbasicanswers`
  ADD PRIMARY KEY (`aid`);
...
--
-- AUTO_INCREMENT for table `cppbasic`
--
ALTER TABLE `cppbasic`
  MODIFY `qid` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `cppbasicanswers`
--
ALTER TABLE `cppbasicanswers`
